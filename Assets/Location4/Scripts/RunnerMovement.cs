...
public class RunnerMovement : MonoBehaviour
{
    ...
    private int desiredLane = 1; //ein integer f�r jede linie 0 f�r links, 1 f�r mitte, usw
    ...
    [SerializeField] GameObject links, rechts; //das sind die buttons f�r das movement
